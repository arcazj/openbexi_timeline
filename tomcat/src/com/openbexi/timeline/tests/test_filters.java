...
public class test_filters {
    ...
    public void test_case10() {
        ...
        Object json = data.updateFilter("deleteFilter", "ob_timeline_2", "0", "Timeline report",
                ...
                "0", "0", "1350", "600", "Orthographic", "NONE",
                data.get_filter());
        String filter1 = "{\"dateTimeFormat\":\"iso8601\",\"openbexi_timeline\":[{\"backgroundColor\":\"#a1d9ff\",\"start\":\"current_time\",\"title1\":\"Timeline report\",\"filters\":[],\"top\":\"0\",\"left\":\"0\",\"name\":\"ob_timeline_2\",\"width\":\"1350\",\"sortBy\":\"NONE\",\"camera\":\"Orthographic\",\"user\":\"test\",\"email\":\"test@mail.com\",\"height\":\"600\"}],\"scene\":\"0\"}";
        String filter2 = json.toString();
        Assert.assertEquals(filter1, filter2);
    }
}
