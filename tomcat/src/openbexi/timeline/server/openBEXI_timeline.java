...
public class openBEXI_timeline implements Runnable {
    ...
    openBEXI_timeline(openbexi.timeline.server.ob_mode mode, String data_path, String filter_include, String filter_exclude) {
        _ob_mode = mode;
    ...
    public static void main(String[] args) {
        ...
        openBEXI_timeline webServer_timeline_no_secure = new openBEXI_timeline(openbexi.timeline.server.ob_mode.no_secure, data_path, filter_include, filter_exclude);
        webServer_timeline_no_secure.run();
        openBEXI_timeline webServer_timeline_secure = new openBEXI_timeline(openbexi.timeline.server.ob_mode.secure, data_path, filter_include, filter_exclude);
        webServer_timeline_secure.run();
        openBEXI_timeline webServer_timeline_sse = new openBEXI_timeline(openbexi.timeline.server.ob_mode.secure_sse, data_path, filter_include, filter_exclude);
